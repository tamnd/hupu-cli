...
// HTTP behaviour is covered in hupu_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "hupu://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("hupu", "about")
	if err != nil || got.String() != "hupu://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want hupu://page/about", got.String(), err)
	}
}
