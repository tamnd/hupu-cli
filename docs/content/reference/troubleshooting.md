...
Most of these come down to network reality or how hupu-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hupu-cli rate-limits like any public site. hupu already paces
...
Where a surface is gated, hupu reads a cookie or token you supply
...
`hupu`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hupu actually did
